...
%Map Different ROI
   ...
   [BW4,threshOut] = edge(I2,'Canny');
    ...
    %append feature value to data matrix
    data = vertcat(data,[age F1 F2 F3 F4 threshOut]);
    

end

%save data matrix as .mat file
 m = matfile('F:\New_Downloads\ML\high_res.mat','Writable',true);
 m.data=data;